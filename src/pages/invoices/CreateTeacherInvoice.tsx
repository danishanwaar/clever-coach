...
const CreateTeacherInvoice = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.fld_id || !formData.fld_mn || !formData.fld_yr) {
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex items-center gap-4 mb-6">
        <Button variant="outline" size="icon" onClick={() => navigate('/payables')}>
          <ArrowLeft className="h-4 w-4" />
        </Button>
        <h1 className="text-2xl font-bold">Create Teacher Invoice</h1>
      </div>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <Label htmlFor="fld_id" className="required">Teacher</Label>
                <Select
                  ...
                  <SelectContent>
                    {teachers.map((teacher) => (
                      <SelectItem key={teacher.fld_id} value={teacher.fld_id.toString()}>
                        {teacher.fld_id} - {teacher.fld_first_name} {teacher.fld_last_name}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
...
export default CreateTeacherInvoice;
