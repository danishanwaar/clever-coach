...
const CreateStudentInvoice = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await createStudentInvoice({
        ...formData,
      ...
      if (result) {
        ...
        setTimeout(() => {
          navigate('/financials/receivables');
        }, 1000);
      }
    } catch (error) {
      console.error('Failed to create invoice:', error);
      toast.error('Failed to create student invoice. Please try again.');
    }
  };
      ...
      {isCreatingStudentInvoice && (
        <div className="absolute inset-0 bg-white/80 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg shadow-lg border flex flex-col items-center gap-4">
            ...
            <p className="text-lg font-medium text-gray-700">Creating Student Invoice...</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end pt-6">
              ...
              >
                ...
                {isCreatingStudentInvoice ? 'Creating Invoice...' : 'Create Invoice'}
              </Button>
            </div>
          </form>
        </CardContent>
